    ...
    <>
        ...
        <div className='block lg:hidden my-5'>
            ...
            <div className='my-5 px-5 flex gap-5'>
                <button className='bg-red-500 px-4 py-3 rounded font-bold text-white'>Rent ₹249</button>
                <button className='bg-red-500 px-4 py-3 rounded font-bold text-white'>Buy ₹999</button>
            </div>
        </div>
    </>
    )
